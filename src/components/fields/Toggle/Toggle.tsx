...
export const Toggle = ({ label, checked, value }: ToggleProps) => {
  const checkedFinal = checked || !!value || undefined

  return (
    <label className="inline-flex items-center cursor-pointer">
      <input type="checkbox" checked={checkedFinal} className="sr-only peer" />
      <div
        className={cx(
